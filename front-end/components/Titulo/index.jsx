...
const Titulo = () => {
  ...
  if (typeof window === "undefined") {
    return null; // Pode retornar algo diferente, dependendo do seu caso
  }
          ...
          <div className="header-container">
            ...
            <div className="col header-buttons">
              {session?.user ? (
                ...
                <Link href="/login">
                  <i className="ms-2 fs-4 bi bi-person-fill-up text-white">
                    {" "}
                    Logar-se{" "}
                  </i>
                </Link>
              ...
              {clienteNome ? (
                <i
                  className="ms-2 fs-4 bi bi-person-fill-down"
                  style={{ cursor: "pointer" }}
                  onClick={logout}
                ></i>
              ) : (
                <Link href="/login">
                  <i className="ms-2 fs-4 bi bi-person-fill-up text-white"></i>
                </Link>
              )}
            </div>
          </div>
