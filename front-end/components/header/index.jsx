    ...
    <header>
      <div className="header-container">
        ...
        <div className="header-buttons">
          {usuarioNome && usuarioNome !== "Não logado" ? (
            <Link href="/home_deslogado"><i className="ms-2 fs-4 bi bi-person-fill-up text-white"
                ...
                <form onSubmit={handleSubmit(enviaDados)}>
                  <div className="row">
                    ...
                    <div className="col-sm-6">
                      <label htmlhtmlFor="nome" className="form-label">Nome do Usuário</label>
                      <input
                        type="text"
                    ...
                    <div className="col-sm-6">
                      <label htmlhtmlFor="senha" className="form-label">Senha</label>
                      <input
                        type="password"
                        className="form-control"
                        id="senha"
                  ...
                  <div className="row mt-3">
                    ...
                    <div className="col-sm-6">
                      <label htmlhtmlFor="cpf" className="form-label">Cpf</label>
                      <input
                        type="text"
                        className="form-control"
                        id="cpf"
                  ...
                  <div className="row mt-3">
                    ...
                    <div className="col-sm-6">
                      <label htmlhtmlFor="telefone" className="form-label">Telefone</label>
                      <input
                        type="tel"
                        className="form-control"
                        id="telefone"
                    ...
                    <div className="col-sm-6">
                      <label htmlhtmlFor="dtnasc" className="form-label">Data de Nascimento</label>
                      <input
                        type="date"
                        className="form-control"
                        id="dtnasc"
                  ...
                  <div className="row mt-3">
                    ...
                    <div className="col-sm-6">
                      <label htmlhtmlFor="sexo" className="form-label">Sexo</label>
                      <select
                        id="sexo"
                    ...
                    <div className="col-sm-6">
                      <label htmlhtmlFor="bairro" className="form-label">Bairro</label>
                      <input
                        type="text"
                        className="form-control"
                        id="bairro"
                  ...
                  <div className="row mt-3">
                    ...
                    <div className="col-sm-12">
                      <label htmlhtmlFor="perfil" className="form-label">Foto de Perfil</label>
                      <input
                        type="url"
                        className="form-control"
                        id="perfil"
