...
export default function Home() {
    ...
    return (
        <main>
            <div className="hero-section carousel-container">
                <div className="carousel-wrapper">
                    <button className="carousel-button carousel-button-left is-hidden">
                    ...
                    <div className="carousel-track-container">
                        <ul className="carousel-track">
                            <li className="carousel-slide current-slide">
                                <img className="carousel-img" src="public/carousel/pet-01.png" alt="" />
                            </li>
                            <li className="carousel-slide">
                                <img className="carousel-img " src="public/carousel/pet-02.jpg" alt="" />
                            </li>
                            <li className="carousel-slide">
                                <img className="carousel-img " src="public/carousel/pet-03.jpg" alt="" />
                            </li>
                            <li className="carousel-slide">
                                <img className="carousel-img " src="public/carousel/pet-04.jpg" alt="" />
                            </li>
                            <li className="carousel-slide">
                                <img className="carousel-img " src="public/carousel/pet-05.jpg" alt="" />
                            </li>
                        </ul>
                    </div>
            ...
            {/* <!-- our-pet-world --> */}
            <div className="pet-world-container">
            ...
            <footer>
                <div className="footer-container">
                    ...
                    <div className="footer-content">Pelpet é o seu ponto central para adoção de pets. Nosso objetivo é conectar
                        pessoas
                        que desejam adotar com
                        nossos parceiros, ONGs e protetores de animais. Unimos esforços para centralizar informações, promover a
                        adoção responsável e compartilhar conhecimento sobre o bem-estar dos animais. Junte-se a nós nessa
                        missão de
                        dar um lar amoroso aos nossos amigos peludos.</div>
                    <div className="footer-social">
                        <p className="footer-social-title">Redes sociais</p>
                        <span>
                            <img className="footer-social-img" src="public/footer/instagram.png" alt="" />
                            <img className="footer-social-img" src="public/footer/facebook.png" alt="" />
                            <img className="footer-social-img" src="public/footer/twitter.png" alt="" />
                        </span>
